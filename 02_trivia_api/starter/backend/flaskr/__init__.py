...
def create_app(test_config=None):
  ...
  def get_all_categories():
      if request.method == "GET":
          latest_categories = Category.query.order_by(Category.id).all()
          my_cat = {}
  ...
  def get_questions(): 
      if request.method == "GET":
          latest_questions = Question.query.all()
          paginated_questions = paginate_questions(request, latest_questions)
  ...
  def add_question():
      ...
      try:
          question = Question(question=latest_question, answer=latest_answer,
                              difficulty=latest_difficulty, category=latest_category)
          question.insert()
